...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<ValidationError> entityNovalidationtFound(MethodArgumentNotValidException e,
	...
	public ResponseEntity<StandardError> illeaglArgument(IllegalAccessException e, HttpServletRequest request) {
		HttpStatus status = HttpStatus.BAD_REQUEST;
		StandardError err = new StandardError();
		err.setTimestamp(Instant.now());
		err.setStatus(status.value());
