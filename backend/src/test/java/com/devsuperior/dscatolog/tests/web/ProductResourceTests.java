...
public class ProductResourceTests {
	...
	@Test
	public void deleteShouldReturnContent204WhenIdExists() throws Exception {
	...
	@Test
	public void insertShouldReturnProductDTOWhenDoesNotNameExists() throws Exception {
	...
	@Test
	public void insertShouldReturnProductDTOWhenDoesNotPricePositive() throws Exception {
		
		String acessToken = obtainAccessToken(operatorUserName, operatorPassword);
		
		newProductDTO.setPrice(-1.00D);
		String jsonBody = objectMapper.writeValueAsString(newProductDTO);
